        ...
        <div class="row">
            <div class="mx-auto col col-12 col-sm-11 col-md-9 col-lg-7 col-xl-6">
                <form class="border border-light p-5" method="POST" action="{{ route('user.register') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div>
                            <small id="defaultRegisterFormPasswordConfirmationHelpBlock"
                                class="form-text text-muted">パスワードと同じものを入力してください。<br /></small>
                        </div>
                    </div>
                    ...
                    <button class="btn btn-info my-4 btn-block" id="defaultRegisterButton" type="submit" disabled>登録</button>
